...
/*CONSTANTS*/
// We have 20 columns and 50 rows so we get a random in that range
...
export default class PathfindingVisualizer extends Component {
  ...
  render() {
    ...
    return (
      <>
        <button className='f5 btn no-underline neon bg-animate hover-bg-white hover-black inline-flex items-center pa3 ba border-box mr4 mt3' onClick={() => this.visualizeDijkstra()}>
          Visualize!
        </button>
        <div className="grid">
          {grid.map((row, rowIdx) => {
